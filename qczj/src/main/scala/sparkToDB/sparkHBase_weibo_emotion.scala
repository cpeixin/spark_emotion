...
object sparkHBase_weibo_emotion {
  ...
  //判断表是否存在并创建
  if (!hadmin.isTableAvailable("weibo_content2")) {
    print("Table Not Exists! Create Table")
    val tableDesc = new HTableDescriptor("weibo_content2")
    tableDesc.addFamily(new HColumnDescriptor("wb".getBytes()))
  ...
  def main(args: Array[String]): Unit = {
    ...
    rdd.foreachRDD(line =>{
      line.foreachPartition( iter =>{
        iter.foreach( line =>{
          insert("weibo_content2",line._4, "wb", "user_fansNum", line._1)
          insert("weibo_content2",line._4, "wb", "text", line._2)
          insert("weibo_content2",line._4, "wb", "user_header", line._3)
          insert("weibo_content2",line._4, "wb", "created_timestamp", line._4)
          insert("weibo_content2",line._4, "wb", "address", line._5)
          insert("weibo_content2",line._4, "wb", "user_gender", line._6)
          insert("weibo_content2",line._4, "wb", "user_name", line._7)
          insert("weibo_content2",line._4, "wb", "user_verified", line._8)
          insert("weibo_content2",line._4, "wb", "emotion", line._9)
        })
      })
    })
    ssc.start()
